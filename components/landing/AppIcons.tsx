// Material Symbols paths extracted verbatim from @mui/icons-material so the
// landing demo renders the *same* glyphs as the real Keystone app shell.
// Keep these in sync with keystone/src/interfaces/renderer/App.tsx imports.
...
const ICON_PATHS = {
  ...
  EnhancedEncryption:
    "M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2M8.9 6c0-1.71 1.39-3.1 3.1-3.1s3.1 1.39 3.1 3.1v2H8.9zM16 16h-3v3h-2v-3H8v-2h3v-3h2v3h3z",
  NetworkPing:
  ...
  DataUsage:
    "M13 2.05v3.03c3.39.49 6 3.39 6 6.92 0 .9-.18 1.75-.48 2.54l2.6 1.53c.56-1.24.88-2.62.88-4.07 0-5.18-3.95-9.45-9-9.95M12 19c-3.87 0-7-3.13-7-7 0-3.53 2.61-6.43 6-6.92V2.05c-5.06.5-9 4.76-9 9.95 0 5.52 4.47 10 9.99 10 3.31 0 6.24-1.61 8.06-4.09l-2.6-1.53C16.17 17.98 14.21 19 12 19",
  MenuBook:
  ...
  Terminal:
    "M20 4H4c-1.11 0-2 .9-2 2v12c0 1.1.89 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.89-2-2-2m0 14H4V8h16zm-2-1h-6v-2h6zM7.5 17l-1.41-1.41L8.67 13l-2.59-2.59L7.5 9l4 4z",
  Verified:
  ...
  Memory:
    "M15 9H9v6h6zm-2 4h-2v-2h2zm8-2V9h-2V7c0-1.1-.9-2-2-2h-2V3h-2v2h-2V3H9v2H7c-1.1 0-2 .9-2 2v2H3v2h2v2H3v2h2v2c0 1.1.9 2 2 2h2v2h2v-2h2v2h2v-2h2c1.1 0 2-.9 2-2v-2h2v-2h-2v-2zm-4 6H7V7h10z",
  PlayArrowRounded:
    "M8 6.82v10.36c0 .79.87 1.27 1.54.84l8.14-5.18c.62-.39.62-1.29 0-1.69L9.54 5.98C8.87 5.55 8 6.03 8 6.82",
  ...
  Compare:
    "M10 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h5v2h2V1h-2zm0 15H5l5-6zm9-15h-5v2h5v13l-5-6v9h5c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2",
  Tune:
  ...
  VpnKey:
    "M12.65 10C11.83 7.67 9.61 6 7 6c-3.31 0-6 2.69-6 6s2.69 6 6 6c2.61 0 4.83-1.67 5.65-4H17v4h4v-4h2v-4zM7 14c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2",
  Lock:
  ...
  AddTask:
    "M22 5.18 10.59 16.6l-4.24-4.24 1.41-1.41 2.83 2.83 10-10zM12 20c-4.41 0-8-3.59-8-8s3.59-8 8-8c1.57 0 3.04.46 4.28 1.25l1.45-1.45C16.1 2.67 14.13 2 12 2 6.48 2 2 6.48 2 12s4.48 10 10 10c1.73 0 3.36-.44 4.78-1.22l-1.5-1.5c-1 .46-2.11.72-3.28.72m7-5h-3v2h3v3h2v-3h3v-2h-3v-3h-2z",
  School:
    "M5 13.18v4L12 21l7-3.82v-4L12 17zM12 3 1 9l11 6 9-4.91V17h2V9z",
  LibraryBooks:
    "M4 6H2v14c0 1.1.9 2 2 2h14v-2H4zm16-4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2m-1 9H9V9h10zm-4 4H9v-2h6zm4-8H9V5h10z",
  Explore:
  ...
  SwapHoriz:
    "M6.99 11 3 15l3.99 4v-3H14v-2H6.99zM21 9l-3.99-4v3H10v2h7.01v3z",
  Info:
  ...
  Security:
    "M12 1 3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11z",
  Restore:
    "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9m-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8z",
...
// Convenience wrappers so call sites read like component usage.
const make = (name: AppIconName) =>
  function Icon({ className = "", style }: IconProps) {
    return <AppIcon name={name} className={className} style={style} />;
  };

export const SpeedIcon = make("Speed");
export const EncryptionIcon = make("EnhancedEncryption");
export const QuantumIcon = make("NetworkPing");
export const ScheduleIcon = make("Schedule");
export const VisualizeIcon = make("DataUsage");
export const CodexIcon = make("MenuBook");
export const HistoryIcon = make("History");
export const ImportIcon = make("Upload");
export const SettingsIcon = make("Settings");
export const TerminalIcon = make("Terminal");
export const VerifiedIcon = make("Verified");
export const CheckCircleIcon = make("CheckCircle");
export const ErrorIcon = make("Error");
export const BarChartIcon = make("BarChart");
export const RefreshIcon = make("Refresh");
export const SearchIcon = make("Search");
export const MoreHorizIcon = make("MoreHoriz");
export const LightModeIcon = make("LightMode");
export const ArrowForwardIcon = make("ArrowForward");
export const DashboardIcon = make("SpaceDashboard");
export const InsightsIcon = make("Insights");
export const MemoryIcon = make("Memory");
export const PlayArrowIcon = make("PlayArrowRounded");
export const ChevronRightIcon = make("ChevronRight");
export const DarkModeIcon = make("DarkMode");
export const CompareIcon = make("Compare");
export const TuneIcon = make("Tune");
export const ShowChartIcon = make("ShowChart");
export const AssessmentIcon = make("Assessment");
export const ComputerIcon = make("Computer");
export const RadioCheckedIcon = make("RadioButtonChecked");
export const VpnKeyIcon = make("VpnKey");
export const LockIcon = make("Lock");
export const LockOpenIcon = make("LockOpen");
export const CreateIcon = make("Create");
export const ViewListIcon = make("ViewList");
export const AddTaskIcon = make("AddTask");
export const SchoolIcon = make("School");
export const LibraryBooksIcon = make("LibraryBooks");
export const ExploreIcon = make("Explore");
...
export const SwapHorizIcon = make("SwapHoriz");
export const InfoIcon = make("Info");
export const PaletteIcon = make("Palette");
export const SecurityIcon = make("Security");
export const RestoreIcon = make("Restore");
export const AddIcon = make("Add");
export const DeleteIcon = make("Delete");
export const ContentCopyIcon = make("ContentCopy");
export const VisibilityIcon = make("Visibility");
export const VisibilityOffIcon = make("VisibilityOff");
export const ScienceIcon = make("Science");
export const PlaylistPlayIcon = make("PlaylistPlay");
